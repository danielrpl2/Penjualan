...
<body>
    ...
    <div id="tm-wrap">
        <div class="tm-main-content">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6 col-md-col-xl-6 mb-md-0 mb-sm-4 mb-4 tm-site-header-col">
                        <div class="tm-site-header">
                            <h1 class="mb-4">Store Daniel</h1>
                            <img src="img/underline.png" class="img-fluid mb-4">
                            <p>Selamat Datang Di Toko Daniel, Semua Barang Ada Disini, Selamat Berbelanja</p>        
                        </div>                        
                    </div>
                                ...
                                <div class="grid__item" id="home-link">
                                    <div class="product">
                                        <div class="tm-nav-link">
                                            ...
                                            <span class="tm-nav-text">DASHBOARD</a></span>
                                            <div class="product__bg"></div>        
                                        </div>                                    
                                        <div class="product__description">
                                            <div class="row mb-3">
                                                <div class="col-12">
                                                    <h2 class="tm-page-title">Welcome To Dashboard</h2>        
                                                     <h2 class="tm-page-title"><a href="dashboard">=> Silahkan Masuk <=</a></h2>        
                                                </div>
                                            </div>                                        
            ...
            <footer>
                <p class="small tm-copyright-text">Copyright &copy; <span class="tm-current-year">2022</span> DANIEL REZA: <a rel="nofollow" href="https://www.tooplate.com" class="tm-text-highlight">STORE</a></p>
            </footer>
        </div> <!-- .tm-main-content -->  
    </div>
    <!-- load JS -->
