...
<div class="page-heading">
 ...
 <form action="/transaksi/edit/{{ $transaksi->id }}" method="POST">
  ...
  <option selected>SILAHKAN DIPILIH SESUAI KEBUTUHAN</option>
  <option value=""></option>
</select>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
    <label>ID DIT</label>
    <input type="text" class="form-control" name="id_dit" value="{{ $transaksi->id_dit }}">
  </div>
   <div class="form-group">
    <label>JML</label>
    <input type="text" class="form-control" name="jml" value="{{ $transaksi->jml }}">
  </div>
   <div class="form-group">
    <label>TOTAL</label>
